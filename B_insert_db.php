<?php
    ...
    if($pass == $cpass)
{
    $sql = "INSERT INTO `signup`(`user`, `pass`, `fname`, `lname`, `id`, `faculty`, `department`, `tel`, `email`, `facebook`, `line`, `address`) VALUES ('$user','$pass','$fname','$lname','$id','$faculty','$department','$tel','$email','$fb','$lineid','$address')";
